    ...
    <b-col sm="12">
      <b-card>
        <div slot="header">
          ...
          List Permission
          <b-link class="float-right btn btn-primary" :to="{ name: 'Create Permission'}">Create</b-link>
        </div>
        <vue-good-table
...
export default {
  ...
  methods: {
    ...
    edit(id){
      this.$router.push({ name: 'Edit Permission', params: { id: id } });
    },
    del(id) {
      swal({
        title: "Are you sure?",
        ...
        if (willDelete) {
          ...
          this.url_delete = "/api/permission/delete";
